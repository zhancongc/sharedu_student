...
<template>
    ...
    <view v-if="!storeId" class="padding-xl" style="margin-top: 460upx; margin-bottom: 460upx;">
		<!-- <view v-if="!storeId" class="padding-xl" :style="'margin-top:' + topBorder + 'px;'"> -->
			<button class="cu-btn block bg-green lg"
				@click="jumpTo($event, '/pages/store_create/store_create')">
				<!--text class="cuIcon-upload"></text-->
				创建店铺</button>
		</view>
		<view v-if="storeId" class="cu-card case no-card">
